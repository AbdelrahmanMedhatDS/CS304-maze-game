...
public class HowToPlayScene implements GLEventListener, KeyListener {
    ...
    private final int textLen = textureNames.length;
    private int[] textureID = new int[textLen];
    private TextureReader.Texture[] textures = new TextureReader.Texture[textLen];
    public void start() {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glGenTextures(textLen, textureID, 0);
    ...
    public void drawBackground(GL gl ,int textureIndex) {
