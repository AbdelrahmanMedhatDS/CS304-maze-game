...
public class MainMenuScene implements GLEventListener, KeyListener {
    ...
    private GLUT glut;
    musicPlayer musicPlayer = new musicPlayer(); // For background music
    ...
    public void start() {
        ...
        musicPlayer.playBackgroundMusic("src/utilities/sounds/menu.wav");
    }
...
//        gl.glClearColor(0.10980392f, 0.125490f, 0.1450980f, 1.0f);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        drawText(gl, "PRESS: 1 OR 2 OR 3", -0.2f, -0.2f);
        drawText(gl, "1 -> Start Play", -0.2f, -0.4f);
        drawText(gl, "2 -> How to Play", -0.2f, -0.5f);
        drawText(gl, "3 -> Exit", -0.2f, -0.6f);
