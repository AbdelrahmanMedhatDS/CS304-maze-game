...
public class GameScene implements GLEventListener, KeyListener {
    ...
    public void start() {
        ...
        animator.start();
        // Play background music for GameScene
        musicPlayer1.playSoundEffect("src/utilities/sounds/game-start.wav");
        musicPlayer1.playBackgroundMusic("src/utilities/sounds/inGame.wav");
    }
...
//            gameoverScene.start();
    ...
    public void keyPressed(KeyEvent e) {
        ...
        try{
            ...
            if (!gamePaused) {
                // player_1 Moving
                if (key == KeyEvent.VK_UP && maze[player1Y + 1][player1X] == 0){ player1Y++ ; musicPlayer1.playSoundEffect("src/utilities/sounds/player1-jump.wav");}
                else if (key == KeyEvent.VK_DOWN && maze[player1Y - 1][player1X] == 0) {player1Y--; musicPlayer1.playSoundEffect("src/utilities/sounds/player1-jump.wav");}
                else if (key == KeyEvent.VK_LEFT && maze[player1Y][player1X - 1] == 0) {player1X--; musicPlayer1.playSoundEffect("src/utilities/sounds/player1-jump.wav");}
                else if (key == KeyEvent.VK_RIGHT && maze[player1Y][player1X + 1] == 0) {player1X++; musicPlayer1.playSoundEffect("src/utilities/sounds/player1-jump.wav");}


                // player_2 Moving
                if (key == KeyEvent.VK_W && maze[player2Y + 1][player2X] == 0) {player2Y++; musicPlayer1.playSoundEffect("src/utilities/sounds/player2-jump.wav");}
                else if (key == KeyEvent.VK_S && maze[player2Y - 1][player2X] == 0) { player2Y--; musicPlayer1.playSoundEffect("src/utilities/sounds/player2-jump.wav");}
                else if (key == KeyEvent.VK_A && maze[player2Y][player2X - 1] == 0) { player2X--; musicPlayer1.playSoundEffect("src/utilities/sounds/player2-jump.wav");}
                else if (key == KeyEvent.VK_D && maze[player2Y][player2X + 1] == 0) { player2X++; musicPlayer1.playSoundEffect("src/utilities/sounds/player2-jump.wav");}
                ...
                if (key == KeyEvent.VK_BACK_SPACE) {
                    ...
                    // Stop music when going back to the main menu
                    musicPlayer1.stopBackgroundMusic();
                }
